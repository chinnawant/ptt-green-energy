def globalVariable(envName){
    ...
    env.skip_stage              = [ "unit_test": true, "quality_analysis": true, "sca_black_duck": true, "sast_coverity": true, "image_scan_trivy": true, "dast_owasp_zap": false, "performance_test": false, "health_check_dev": false, "automate_test_dev": false, "health_check_sit": false, "automate_test_sit": false, "health_check_uat": false, "automate_test_uat": false, "health_check_prd": false]
